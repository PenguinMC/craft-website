...
(function () {
  ...
  const KB = [
    ...
    { q: ['ifr', 'instrument', 'instrument rating'], a: "Accelerated IFR is <strong>7 days</strong> (6 days training + 7th-day checkride): $9,800 in our DA40 NG, $5,850 BYOP. Up to 30 hrs flight + Redbird sim, dedicated CFII. <a href='/accelerated'>Details →</a>" },
    { q: ['commercial', 'cpl'], a: "Accelerated Commercial is <strong>6 days</strong> at $8,600 in the DA40 NG. Need 240+ total hours to enroll. <a href='/accelerated'>Details →</a>" },
    { q: ['multi', 'me', 'multi-engine'], a: "Multi-Engine Add-On is <strong>4 days</strong>, $9,000 in the DA42-VI twin turbodiesel. +DPE fee $1,500 cash. No FAA knowledge test required. <a href='/accelerated'>Details →</a>" },
    { q: ['cfi', 'instructor'], a: "CFI Initial: <strong>10–12 days</strong>, $12,000 in our DA40 NG. 18 hrs flight + 53 hrs ground + 4 sim hrs. +DPE $1,500–$1,700. Bundle with CFII for $16,950 total (saves $200). <a href='/accelerated'>Details →</a>" },
    { q: ['cfii', 'cfi-i', 'instrument instructor'], a: "CFII Add-On: <strong>4 days</strong>, $5,600 in the DA40 NG, $3,200 BYOP, +DPE ~$800. Active CFI required. <a href='/accelerated'>Details →</a>" },
