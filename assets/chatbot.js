...
.cb-gate-form input { width: 100%; padding: 11px 13px; font-family: inherit; font-size: 13px; color: #fff; background: rgba(10,13,18,0.7); border: 1px solid rgba(255,255,255,0.12); border-radius: 6px; outline: none; }
...
.cb-gate-btn { padding: 13px 16px; background: var(--beacon, #E63027); color: #fff; border: none; border-radius: 6px; font-family: 'Barlow Condensed', sans-serif; font-weight: 700; font-size: 13px; letter-spacing: 0.08em; text-transform: uppercase; cursor: pointer; margin-top: 4px; }
...
`;
  ...
  gateBtn.addEventListener('click', () => {
    ...
    fetch('https://api.hsforms.com/submissions/v3/integration/submit/50822208/a22614d5-4579-4ad1-95d1-d497805dae61', {
      method: 'POST',
